(function () {
  ...
  style.textContent = `/* All your CSS from the original <style> tag goes here */` + `
    #chat-widget {
      position: fixed;
      bottom: 50px;
      right: 50px;
    ...
    <div id="intro-chatbox">
      ...
      <div class="chatbox-body">
        ...
        <div class="chatbox-input">
          ...
          <button id="sendButton"><span class="material-symbols-outlined send-icon">send</span></button>
        </div>
      </div>
    </div>
  `;
